    ...
    return (
      <div className="h-screen flex items-center justify-center" style={{ background: '#0F1923' }}>
        <div className="text-center">
          ...
          <p className="text-sm" style={{ color: 'rgba(245,240,232,0.4)', fontFamily: 'DM Sans, sans-serif' }}>
            Chargement…
          </p>
        </div>
      </div>
    ...
    return (
      <div className="h-screen flex flex-col items-center justify-center p-6" style={{ background: '#0F1923' }}>
        <div className="text-center max-w-sm w-full">
          ...
          >
            <p className="text-xs mb-3" style={{ color: 'rgba(245,240,232,0.3)' }}>
            ...
            <a href="/dashboard" className="block">
              <button
                ...
                style={{ background: 'rgba(245,240,232,0.05)', color: 'rgba(245,240,232,0.5)', border: '0.5px solid rgba(245,240,232,0.1)' }}
              >
                Retour au dashboard
              </button>
            </a>
    ...
    return (
      <div className="h-screen flex flex-col items-center justify-center p-6" style={{ background: '#0F1923' }}>
        <div className="text-center max-w-sm w-full">
          ...
          <p className="text-xs mb-8" style={{ color: 'rgba(245,240,232,0.35)' }}>
    ...
    return (
      <div className="h-screen flex flex-col" style={{ background: '#0F1923' }}>
        ...
        <div
          ...
          style={{ background: '#1A2733', borderBottom: '0.5px solid rgba(201,168,76,0.2)' }}
        >
          <div
          ...
          <div className="min-w-0">
            ...
            <p className="text-sm font-medium truncate" style={{ color: '#F5F0E8', fontFamily: 'Syne, sans-serif' }}>
              {contractName}
            </p>
          </div>
        </div>
        ...
        <div
          ...
          style={{ background: 'rgba(201,168,76,0.05)', borderBottom: '0.5px solid rgba(201,168,76,0.1)' }}
        >
          ...
          {contractUrl && (
            <a href={contractUrl} target="_blank" rel="noopener noreferrer" className="w-full max-w-xs">
              <button
                ...
                style={{ background: 'rgba(201,168,76,0.1)', color: '#C9A84C', border: '0.5px solid rgba(201,168,76,0.3)' }}
              >
    ...
    <div className="h-screen flex flex-col" style={{ background: '#0F1923' }}>
      ...
      >
        <p className="text-sm" style={{ color: 'rgba(245,240,232,0.6)' }}>
          <strong style={{ color: '#C9A84C' }}>{signerName}</strong> · {new Date().toLocaleDateString('fr-FR', {
      ...
      <div className="flex-1 relative" style={{ background: '#1A2733' }}>
        ...
        />
        <p
          className="absolute bottom-3 left-6 text-xs pointer-events-none"
      ...
      <div
        ...
        style={{ background: '#0F1923', borderTop: '0.5px solid rgba(201,168,76,0.15)' }}
      >
